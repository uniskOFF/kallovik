  ...
  return (
    <section id="contacts" className="relative overflow-hidden bg-[#05080f] py-32 sm:py-40">
      <div className="absolute inset-0">
        ...
        <div className="absolute right-0 top-0 h-[400px] w-[400px] rounded-full bg-purple-500/4 blur-[160px]" />
        <div className="absolute bottom-0 left-0 h-[400px] w-[400px] rounded-full bg-cyan-500/3 blur-[160px]" />
      </div>
      ...
      <div className="relative mx-auto max-w-7xl px-6 sm:px-8 lg:px-12">
        ...
        <div className="grid grid-cols-1 gap-16 lg:grid-cols-[0.9fr_1.1fr] lg:gap-20">
          ...
          >
            <div>
              <p className="text-2xl font-light leading-[1.4] tracking-[-0.01em] text-white/50 sm:text-3xl">
                {t.contact.subtitle}
              </p>
              ...
              <div className="mt-12 space-y-6">
                ...
                <div className="space-y-2 text-sm font-light text-white/20">
                  <p>Telegram: @aesbau_labs</p>
                  <p>Email: hello@aesbau.dev</p>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <div className="relative rounded-3xl border border-white/[0.04] bg-white/[0.02] p-8 backdrop-blur-sm sm:p-10">
              <div className="absolute -right-20 -top-20 h-80 w-80 rounded-full bg-accent/4 blur-[120px]" />
              <div className="absolute -left-20 -bottom-20 h-80 w-80 rounded-full bg-purple-500/4 blur-[120px]" />

              <form onSubmit={onSubmit} className="relative space-y-6">
                <div>
                  <label className="mb-2 block text-sm font-light text-white/30">
                    {t.contact.name}
                  </label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="mb-3 block text-sm font-light text-white/30">
                    ...
                    {contactMethods.map((method) => {
                      ...
                      return (
                        <motion.button
                          ...
                          className={`relative flex items-center gap-2.5 rounded-full border px-4 py-2 text-sm font-light transition-all duration-500 ${
                            isSelected
                ...
                {!selectedMethod && (
                  <p className="text-center text-sm text-white/15">
